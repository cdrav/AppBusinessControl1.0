-- ========================================
-- MIGRACIÓN SIMPLE - BASE DE DATOS
-- ========================================
...
ALTER TABLE sales ADD COLUMN IF NOT EXISTS coupon_code VARCHAR(50);
ALTER TABLE sales ADD COLUMN IF NOT EXISTS notes TEXT;
ALTER TABLE sales ADD COLUMN IF NOT EXISTS branch_id INT;
...
SHOW COLUMNS FROM sales LIKE 'is_credit';
